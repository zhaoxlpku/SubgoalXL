...
def run(exp_name, num_workers, endpoint_manager_name, model_name_or_path, prompt_manager_name, max_response_len, **kwargs):
    ...
    prompt_manager_class = import_class(prompt_manager_name, "training.rejection_sampling_formal_statement")
    ...
    for i, start_index in enumerate(start_indices):
        ...
        cmd = [
            "python", "rejection_sampling_formal_statement.py",
            ...
            "--num_samples", str(kwargs.get("num_samples", 8)), 
            "--temperature", str(kwargs.get("temperature", 0.6)),
            "--subgoal_dir", str(kwargs.get("subgoal_dir", "")),
        ]
